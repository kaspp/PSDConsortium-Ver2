...
import consortium.psd.Object.Course;
...
public class CourseController {
	...
	public void save() {
		String url = "/Users/Derrick/Documents/Programming/Java/CourseAllocation/Database/course.csv";
		try {
	...
	public void initData() {
		...
		try {
			...
			br = new BufferedReader(
					new FileReader(
							"/Users/Derrick/Documents/Programming/Java/CourseAllocation/Database/course.csv"));
			while ((sCurrentLine = br.readLine()) != null) {
				String[] temp = sCurrentLine.split(",");
				if (isInteger(temp[0])) {
					c.add(new Course(Integer.parseInt(temp[0]), temp[1],
